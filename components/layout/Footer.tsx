      ...
      <Container width="wide" className="py-12 md:py-16">
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-3 md:gap-12">
          <div>
            ...
            <p className="text-body-sm text-ink-inverse/80">{tFooter("status501c3")}</p>
        ...
        <div className="mt-12 pt-6 border-t border-brand-strong text-body-sm text-ink-inverse/70">
